...
<%
    ...
    String directory = "D:/ksh/local-project/local-project/src/main/webapp/upload";
    ...
    try {
        ...
        sql = "INSERT INTO board(title, content, type, file_id, created_ip, created_by, created_at, modified_by, modified_ip, modified_at) VALUES(?, ?, 'Q', ?, ?, ?, now(), ?, 'TEST', now())";
        psmt = conn.prepareStatement(sql);
