...
%>
                <div class="commentRow">
                    ...
                    <span>
                        <button onclick="modifyFn(this,<%=commentId%>)">수정</button>
                        <button onclick="replyDelFn(<%=commentId%>,this)">삭제</button>
                    </span>
                    <button onclick="replyFn(<%=commentId%>,this)">답글</button>
                </div>
                
               <form name="replyfrm_<%=commentId%>"
							style="display: none;">
							<input type="hidden" name="board_id"
								value="<%=comment.getBoardId()%>"> 답글 : <input type="text"
								name="content">
							<button type="button"
								onclick="replyInsertFn(<%=commentId%>)">저장</button>
						</form> 
