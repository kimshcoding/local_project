...
try {
	...
	//---------------------- 동네업체 게시판 데이터 가져오기 ---------------------------------------------
	sql = "SELECT lb_id, content, title, m.nicknm, b.created_by, b.created_at, b.hit , b.local_extra, b.post_code, b.addr, b.addr_detail "
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-8">
					<div>
						...
						<span><%=board.getNicknm()%></span> &nbsp&nbsp <span><%=board.getCreatedAt()%></span>
						<!------------------------- 좋아요-------------------------- -->
				...
				function toggleLike(boardId, button) {
					...
					<div class="text-center">
						...
						이웃에게 이용 경험을 알려보세요.
						<button
							onclick="location.href='reviewWrite.jsp?board_id=<%=board.getBoardId()%>'"
