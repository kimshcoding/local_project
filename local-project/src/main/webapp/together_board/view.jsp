...
try {
	...
	+ " INNER JOIN member m" + " ON b.created_by = m.member_id   " + " WHERE b.board_id = ? AND b.type = 'T'"; // 자유게시판 T 데이터만 가져옴!
	...
	sql = "SELECT * FROM board WHERE type = 'T' and delyn='N' and board_id < ? order by board_id DESC limit 0,1 "; // ? -> 현재 페이지 board_id
	...
	sql = "SELECT * FROM board WHERE type = 'T' and delyn='N' and board_id > ? order by board_id ASC limit 0,1 "; // ? -> 현재 페이지 bno
			...
			<div class="row">
				<div class="col-md-12">
					<div class="heading_container">
						<h2 class="mb-4">같이해요 게시판 상세보기</h2>
					</div>
