...
try {
	...
	rs = null;
	String sql = "SELECT board_id, title, m.nicknm, b.created_at, b.hit, m.addr_extra " +
            "FROM board b " +
            "INNER JOIN member m ON b.created_by = m.member_id " +
            "WHERE b.delyn = 'N' AND b.type = 'G'";
...
<body class="sub_page">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p>동네 한 바퀴 사이트의 운영, 이벤트 관련 공지를 하는 게시판입니다.</p>
