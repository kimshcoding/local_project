...
if (member == null) {
    ...
    try {
        ...
        // 회원이 작성한 글 목록을 조회
        String sql = "SELECT b.board_id, b.title, b.created_at, b.hit, m.nicknm, m.addr_extra " +
             "FROM board b " +
             "INNER JOIN member m ON b.created_by = m.member_id " +
             "WHERE b.created_by = ? AND b.delyn = 'N' " +
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-8 text-truncate">
                                            <a href="<%=request.getContextPath() %>/free_board/view.jsp?board_id=<%=boardId%>"><%=title%></a>
                                        </div>
                                    </div>
                                </td>
                                <td><%=createdAt%></td>
